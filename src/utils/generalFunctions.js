...
class CustomControl extends Control {
  ...
  static getDefinition() {
    return {
      type: 'signature',
      other: true,
      values: $('.js-signature').jqSignature('getDataURL'),
      i18n: {
        en: {
          label: 'Custom Control',
          description: 'A custom control with extended functionality.',
        },
      },
    };
  }
  ...
  build() {
    ...
    controlElement.textContent = this.config.i18n.en.label;
...
Control.register('signature', CustomControl);
...
export let fields = [
  {
    ...
    label: 'Primary Adult Participant', attrs: {
  ...
  additionalParticipants: function (fieldData) {
    return {
      ...
      onRender: function () {
        ...
        element.append('<div class="flex items-center justify-center"><button class="text-sm px-4 py-2 bg-gray-800 rounded-md font-semibold text-white hover:bg-gray-700 active:bg-gray-900 focus:outline-none disabled:opacity-25 transition ease-in-out duration-150">1</button></div>');
      }
    };
  },
  ...
  signature: function (fieldData) {
    return {
      onRender: function () {
        ...
        element.append(`
        <div class="relative">
        <div style="position: absolute; width: 100%; height: 100%; vertical-align: middle; cursor: pointer" onclick="this.remove();">
  ...
  primaryAdultParticipant: function (fieldData) {
    return {
      onRender: function () {
        let element = $(`.field-${fieldData.name}`);
        element.append(`
        <div class="space-y-2 adult primary-adult-participant-1698913371357-0-preview">
          <div class="mt-3">
      ...
      onRender: function () {
        ...
        <div class="relative flex items-start py-4 px-2">
          <div class="flex h-5 items-center">
            <input name="electronic-signature-consent" type="checkbox" class="h-6 w-6 rounded border-gray-300 ring-primary focus:ring-primary">
          </div>
    ...
    return {
      onRender: function () {
        ...
        <div class="p-2">
                ...
                <div>
                    <button type="button" class="mt-5 px-3 py-2 text-xs font-medium text-center text-white bg-[#66615b] rounded-lg ">Capture Photo</button>
                </div>
            </div>
      `);
      }
...
export let options = {
  fields, templates, disableFields: ['autocomplete', 'textarea', 'button']
};
...
export const formData = [
  {
    ...
    name: "electronicSignatureConsent-1699273224632-0",
    access: false,
  }
];
