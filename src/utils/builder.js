  ...
  signature: function (fieldData) {
    return {
      onRender: function () {
        ...
        onclick="$(this.parentNode).find('.js-signature').jqSignature('clearCanvas');this.classList.add('hidden');$(this).parent().find('.absolute.w-full').removeClass('hidden')"
