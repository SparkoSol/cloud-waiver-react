...
function Template() {
    ...
    useEffect(() => {
        ...
        getRequest('/waivers?statuses=draft&statuses=published')
            .then((r) => {
                setAllTemplates(addCheck(r.data, 't'))
                console.log(r.data)
            })
                ...
                <div className='flex justify-between pb-6'>
                    ...
                    <div className='flex gap-2 items-center'>
                        {selectedCount > 0 && <>
                            ...
                            <Button btnText='Archive' onClick={handleDelete} btnClasses='bg-red-500'
                                    fullWidth='w-fit'/></>}
                ...
                <div>
                    {allTemplates.length > 0 ?
                        <DataTable selectAll={selectAll} setSelectAll={setSelectAll}
                                   headers={['Name', 'Total Waivers', 'Status']} TableRow={TemplateRow}
                                   items={allTemplates}
                                   setState={setAllTemplates} setSelectedCount={setSelectedCount}
                                   deleteRow={deleteRow} customOpenModal={customOpenModal}/> :
